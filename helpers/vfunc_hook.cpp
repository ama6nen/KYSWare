...
vfunc_hook_rtti::vfunc_hook_rtti( )
	: class_base( nullptr ), vftbl_len( 0 ), new_vftbl( nullptr ), old_vftbl( nullptr )
{
}
vfunc_hook_rtti::vfunc_hook_rtti( void* base )
	: class_base( base ), vftbl_len( 0 ), new_vftbl( nullptr ), old_vftbl( nullptr )
{
}
vfunc_hook_rtti::~vfunc_hook_rtti( )
...
bool vfunc_hook_rtti::setup( void* base /*= nullptr*/ )
{
	if ( base != nullptr )
		class_base = base;
...
std::size_t vfunc_hook_rtti::estimate_vftbl_length( std::uintptr_t* vftbl_start )
{
	auto len = std::size_t{ };
