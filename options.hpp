...
#define OPTION(type, var, val) type var = val
	...
	OPTION(bool, glow_health_e, false);
	OPTION(bool, glow_health_f, false);
	OPTION(bool, glow_rb_e, false);
	OPTION(bool, glow_rb_f, false);
	OPTION(bool, glow_rb_o, false);

	OPTION(bool, glow_local, false);
	OPTION(bool, glow_fullbloom_local, false);
	OPTION(bool, glow_occluded_local, true);
	OPTION(bool, glow_unoccluded_local, false);
	OPTION(float, glow_bloomamount_local, 1.f);
	OPTION(int, glow_style_local, 0);
	OPTION(Color, color_glow_local, Color(255, 128, 69));

	OPTION(bool, glow_fullbloom_o, false);
	OPTION(bool, glow_occluded_o, true);
	OPTION(bool, glow_unoccluded_o, false);
	OPTION(float, glow_bloomamount_o, 1.f);
	OPTION(int, glow_style_o, 0);
	...
	OPTION(ButtonCode_t, thirdperson_button, KEY_F1);
	...
	OPTION(Color, color_glow_ally_vis, Color(0, 128, 0));
