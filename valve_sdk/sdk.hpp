...
#include "Interfaces/appsystem.hpp"
#include "Interfaces/baseclientdll.hpp"
...
extern CHostState* g_HostState;
extern IVEffects* g_IVEffects;
extern IEffects* g_IEffects;
...
extern DWORD OverridePostProcessingDisable;
extern C_CSGameRules* g_GameRules;
extern std::unique_ptr<steam_api_context> steam;
...
{
    static auto import = (void(*)(const char*, ...))GetProcAddress( LI_FIND_CACHED( GetModuleHandleW )(L"tier0.dll"), "?ConMsg@@YAXPBDZZ");
    return import(pMsg, args...);
}
template<typename... Args>
void ConColorMsg(const Color& clr, const char* pMsg, Args... args)
{
    static auto import = (void(*)(const Color&, const char*, ...))GetProcAddress( LI_FIND_CACHED( GetModuleHandleW )(L"tier0.dll"), "?ConColorMsg@@YAXABVColor@@PBDZZ");
...
{
	static auto pThis = *reinterpret_cast<DWORD**>(Utils::PatternScan( LI_FIND_CACHED( GetModuleHandleW )(L"client.dll"), "B9 ? ? ? ? E8 ? ? ? ? 83 7D F8 ?") + 1);
	static auto find_hud_element = reinterpret_cast<DWORD(__thiscall*)(void*, const char*)>(Utils::PatternScan( LI_FIND_CACHED( GetModuleHandleW )(L"client.dll"), "55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39 77 28"));
