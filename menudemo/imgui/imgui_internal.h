...
namespace ImGui
{
	...
	IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL, bool color = false);
	IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f);
	IMGUI_API void          RenderFrame_Multi( ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, ImU32 fill_col_2, bool border = true, float rounding = 0.0f );
	IMGUI_API void          RenderFrame_Multi2( ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, ImU32 fill_col_2, bool border = true, float rounding = 0.0f );
	...
	IMGUI_API bool          SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags = 0, const ImRect& total_bb = ImRect());
