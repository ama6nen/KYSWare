...
namespace ImGui
{
	...
	IMGUI_API bool          ToggleButton(const char* label, bool* v, const ImVec2& size = ImVec2(0, 0), int edgy = 0);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool cube = false);
