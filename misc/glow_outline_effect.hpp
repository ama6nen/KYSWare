...
public:
	...
	float   m_flUnknown1; //0x0014
    float   m_flMinVelocityAlpha;             //0x0018
    float   m_flBloomAmount;           //0x001C
    float   m_flLocalPlayerIsZeropoint3;  //0x0020
    bool    m_bRenderWhenOccluded;     //0x0024
    bool    m_bRenderWhenUnoccluded;   //0x0025
    bool    m_bFullBloomRender;        //0x0026
	bool	m_bUnknown2;				   //0x0027
	int32_t	m_nFullBloomStencil;       //asd
