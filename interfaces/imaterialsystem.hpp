...
public:
	...
	int GetActualWidth( )
	{
		typedef int( __thiscall* a )( void* );
		return CallVFunction<a>( this, 3 )( this );
	}
	int GetActualHeight( )
	{
		typedef int( __thiscall* a )( void* );
		return CallVFunction<a>( this, 4 )( this );
	}
};
...
public:
   ...
   virtual void							LoadKeyValuesFromVMTFile(KeyValues& values, const char* name, bool somebool) const = 0; //fuck markhc he didnt have this 
   ...
   virtual MaterialHandle_t                FirstMaterial() const = 0;
	...
	{
		typedef IMatRenderContext*( __thiscall* asdf )( void* );
		return CallVFunction<asdf>( this, 115 )( this );
	}
	bool& gameStarted( )
	{
